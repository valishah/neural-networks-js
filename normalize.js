...
function scaleDown(step) { // normalize , 138 being the low value from the dataset
    return {
        open: step.open / 138,
        high: step.high / 138,
        low: step.low / 138,
...
More generalized approach would be
    open : (stp.open - lowest) / (highest - lowest)
 ...
 */
 ...
 console.log(" ==== Normalization Scaleup ====");
